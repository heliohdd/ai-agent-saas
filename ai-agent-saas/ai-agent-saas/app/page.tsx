...
const steps = [
  {
    ...
    description: "Share your YouTube vide URL and let your agent get to work",
    icon: Video,
  },
  {
...
const features = [
  {
    title: "AI analysis",
    description:
      "Get deep insights inside your video content with our advanced AI analysis. Understand viewer engagement and content quality.",
    icon: Brain,
    iconBg: "bg-blue-100",
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {steps.map((steps, index) => {
              ...
              return (
                <div
                  key={index}
                  className="text-center p-6 rounded-6xl bg-white shadow-md hover:shadow-lg transition-all"
                >
